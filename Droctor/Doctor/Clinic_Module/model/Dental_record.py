...
class DoctorCard(models.Model):
    ...
    chief_complaint = fields.Selection([('Pain', 'Pain'),('Sweling','Sweling'),('Caries', 'Caries'),('Esthetice', 'Esthetice'),('Routine_Visit', 'Routine Visit'),], string="Chief Complaint")
    check1 = fields.Boolean(string="Others")
    Other = fields.Text(string="Comment Chief Complaint")
    medical_history = fields.Selection([('Allergies', 'Allergies'),('Rheumatic_fever','Rheumatic Fever'),('Familial', 'Familial'),('Cardiac_Disease', 'Cardiac Disease'),('Asthma', 'Asthma'), ('Common_chihood_Disease', 'Common Chihood Disease'),('Kidney_Disease', 'Kidney Disease'),('Blood_Dysrasias', 'Blood Dysrasias'),('Diabetes', 'Diabetes'),], string="Medical History")
    check2 = fields.Boolean(string="Others")
    Other_2 = fields.Text(string="Comment Medical History")
    ...
    Other_3 = fields.Text(string="Comment Previous Dental")
    x_RAY = fields.Binary(string="X_RAY")
    comment_x_RAY = fields.Text(string="Comment X_RAY")
    provisional_dlagnosis = fields.Text(string="Provisional Dlagnosis")
    investigations = fields.Text(string="Investigations")
    dlagnosis = fields.Text(string="Dlagnosis")
    treatmentplan = fields.Text(string="Treatment Plan")
    procedure = fields.Text(string="Procedure")
    next_applointment = fields.Datetime(string="Next Applointment")
